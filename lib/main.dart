...
class _MyHomePageState extends State<MyHomePage> {
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                _buildListItem('assets/food1.jpg', 'Salmon', '\$25'),
                _buildListItem('assets/food2.jpg', 'Salad', '\$28'),
              ],
            ),
          ),
          SizedBox(
  ...
  Widget _buildListItem(String imgPath, String foodName, String price) {
    return InkWell(
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => DetailPage(heroTag: imgPath, foodName: foodName, price: price,)));
        },
        child: Padding(
